...
export class TokenPlacer {
    ...
    static _isStepClear(fromX, fromY, toX, toY) {
        ...
        try {
            ...
            if (canvas.walls.checkCollision(ray, { type: 'move', mode: 'any' })) return false;
            ...
            if (len > 0) {
                ...
                if (canvas.walls.checkCollision(rayL, { type: 'move', mode: 'any' })) return false;
                ...
                if (canvas.walls.checkCollision(rayR, { type: 'move', mode: 'any' })) return false;
            }
